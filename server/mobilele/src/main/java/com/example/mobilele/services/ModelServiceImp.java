...
public class ModelServiceImp extends SeedService {
    ...
    @Override
    protected void seed() throws NotFoundException {
    ...
    public void save(ModelCreateDto modelCreateDto) throws NotFoundException, WrongCredentialsException {
        ...
        model.setCategory(
                Arrays.stream(ModelCategory.values())
                        .filter(m -> m.name().equals(modelCreateDto.getCategory()))
                        .findFirst()
                        .orElseThrow(() -> new WrongCredentialsException("Category type is not valid be.\nValid type: Car, Buss, Truck, Motorcycle")));
    ...
    public ModelView edit(ModelEditDto modelEditDto, String id) throws NotFoundException, WrongCredentialsException {
        ...
        if (modelEditDto.getCategory() != null) {
            model.setCategory(modelEditDto.getCategory());
        }
